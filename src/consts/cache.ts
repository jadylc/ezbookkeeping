...
export const SW_ASSETS_CACHE_NAME: string = 'ezfinance-assets-cache';
export const SW_CODE_CACHE_NAME: string = 'ezfinance-code-cache';
export const SW_MAP_CACHE_NAME: string = 'ezfinance-map-cache';
