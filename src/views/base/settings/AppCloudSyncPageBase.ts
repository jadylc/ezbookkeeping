...
export const ALL_APPLICATION_CLOUD_SETTINGS: CategorizedApplicationCloudSettingItems[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { settingKey: 'totalAmountExcludeAccountTagIds', settingName: 'Account Tags Included in Total', mobile: true, desktop: true },
            { settingKey: 'totalAmountTargetCurrency', settingName: 'Total Amount Currency', mobile: true, desktop: true },
